                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="col-md-7">
                                              <input type="text" id="dest-url" class="form-control" name="asin-input">
                                          </div>
                                          <div class="col-md-1">
                                            <span class="f-12px d-inline-block mt-1-2">QUANTITY: </span>
                                          </div>
                                          <div class="col-md-2">
                                              <input type="text" id="dest-url" class="form-control" name="quantity">
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                          <div class="col-md-2">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="col-md-10">
                                              <input type="text" id="dest-url" class="form-control" name="amazon-aff-id">
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                          <div class="col-md-2">
