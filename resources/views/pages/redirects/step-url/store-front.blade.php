          ...
          <div class="card-content">
            <div class="card-body">
              <form action="#" class="number-tab-steps wizard-circle">
                ...
                <fieldset>
                  <div class="row">
                    <h1 class="mb-1">STORE FRONT 2-STEP URL</h1>
                    <div class="col-md-12">
                      <div class="asin-group">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group row">
                              <div class="col-md-6">
                                <label for="merchant-id">Merchant ID <i class="feather icon-info"></i></label>
                                <input type="text" class="form-control" id="merchant-id" name="merchant-id">
                              </div>
                            </div>
                            <div class="form-group row">
                              <div class="col-md-9">
