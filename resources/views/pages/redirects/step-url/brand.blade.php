          ...
          <div class="card-content">
            <div class="card-body">
              <form action="#" class="number-tab-steps wizard-circle">
                ...
                <fieldset>
                  <div class="row">
                    <h1 class="mb-1">BRAND 2-STEP URL</h1>
                    <div class="col-md-12">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group row">
                              ...
                              <div class="col-md-4">
                                <label for="brand-input">BRAND <i class="feather icon-info"></i></label>
                                <input type="text" class="form-control" id="brand-input" name="brand-input">
                              </div>
                            </div>
                            <div class="form-group row">
                              <div class="col-md-9">
